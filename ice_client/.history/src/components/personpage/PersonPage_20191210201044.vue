    ...
    <el-card>
      ...
      <el-row class="userinfo" gutter="20">
        ...
        <el-col :span="14" class="el-col-gap">
          <el-card class="address-gap" v-for="address in userInfo[0].address" :key="address">
            <el-button size="mini" type="info" icon="el-icon-delete" circle @click="deleteAddress(address)"></el-button>
            {{ item }}
          </el-card>
          <!-- 收货地址信息区域 -->
          <!-- <el-table :data="userInfo" stripe>
